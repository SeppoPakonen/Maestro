...
import maestro.convert.inventory_generator
import maestro.convert.planner
import maestro.convert.execution_engine
import maestro.convert.coverage_report
from maestro.convert.conversion_memory import ConversionMemory
from maestro.convert.inventory_generator import generate_inventory, save_inventory
from maestro.convert.execution_engine import execute_conversion
from maestro.convert.coverage_report import generate_coverage_report
...
def cmd_plan(args):
    ...
    from maestro.convert.planner import generate_conversion_plan
