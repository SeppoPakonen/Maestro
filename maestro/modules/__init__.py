...
This package uses lazy attribute resolution to avoid eager side effects on import.
"""
...
_LAZY_MODULES = (
    "maestro.modules.dataclasses",
    "maestro.modules.utils",
    "maestro.modules.cli_parser",
    "maestro.modules.command_handlers",
)
...
def __getattr__(name: str):
    for module_path in _LAZY_MODULES:
