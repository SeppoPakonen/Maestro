...
def add_ux_parser(subparsers) -> argparse.ArgumentParser:
    ...
    eval_parser.add_argument(
        '--out',
        help='Output directory for report (default: docs/workflows/v3/reports/ux_eval_<timestamp>)'
    )
...
def handle_ux_eval(args: argparse.Namespace) -> int:
    ...
    if args.out:
        ...
        output_dir = docs_root / "docs" / "workflows" / "v3" / "reports" / eval_id
