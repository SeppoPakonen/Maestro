...
async def test_menubar_creation():
...
async def test_menubar_view_menu_items():
...
async def test_menubar_mouse_activation():
...
async def test_menubar_keyboard_activation():
...
async def test_menu_item_activation():
...
async def test_menubar_contains_correct_sections():
...
async def run_all_tests():
    """Run all tests."""
    await test_menubar_creation()
    await test_menubar_view_menu_items()
    await test_menubar_mouse_activation()
    await test_menubar_keyboard_activation()
    await test_menu_item_activation()
    await test_menubar_contains_correct_sections()
